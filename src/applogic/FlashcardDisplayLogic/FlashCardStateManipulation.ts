...
export const editTagList2 = (htmlelement: React.FormEvent<HTMLLIElement>, defaultValue: string[], mustBeIn: string[]): string[] => {
...
//(e: React.FormEvent<HTMLLIElement>, tags: string[], strings: string[])
